...
spi_config spi_x[3] = {
		[SPI_1] = {BIDIMODE_DI,SOFTWARE_SLAVE_MANAGEMENT_DI,ERROR_INTERRUPT_DI,TXE_INTERRUPT_DI,RXNE_INTERRUPT_DI,TX_DMA_DI,RX_DMA_DI,FPCLK_DIV_256,CK_TO_ZERO_WHEN_IDLE,FIRST_CLK_TRANSITION_FOR_DATA_CAPTURE,MASTER_CONFIGURATION,MSB_TRANSMITTED_FIRST,EIGHT_BIT_DATA_FORMAT,FULL_DUPLEX},
